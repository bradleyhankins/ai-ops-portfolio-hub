...
TOOL_SELECTOR = {
    ...
    "I want to view the full portfolio": "ClientOps Intake AI",
}
...
def project_card(name: str, project: dict) -> None:
    ...
    st.markdown(f"""
        <div class="project-card">
            <div class="project-topline"><h3 class="project-title">{name}</h3><span class="status-pill status-live">{project['status']}</span></div>
...
with c1: stat_card("Toolkit Projects", "5")
with c2: stat_card("Live Apps", "5")
with c3: stat_card("Primary Stack", "Python + Streamlit")
...
with s3:
    ...
    link_button("Open ClientOps Intake AI", PROJECTS["ClientOps Intake AI"]["live"])
...
st.markdown('<div class="section-lede">The toolkit was built around connected business problems: small businesses need a better way to diagnose workflow bottlenecks, managers need performance visibility, sales teams need follow-up discipline, growing teams need structured applicant review, and organizations need clearer process documentation.</div>', unsafe_allow_html=True)

st.markdown('<div class="section-title">Project portfolio</div>', unsafe_allow_html=True)
p1, p2 = st.columns(2)
with p1: project_card("ClientOps Intake AI", PROJECTS["ClientOps Intake AI"])
with p2: project_card("OpsPilot AI", PROJECTS["OpsPilot AI"])
p3, p4 = st.columns(2)
with p3: project_card("FollowUpPilot AI", PROJECTS["FollowUpPilot AI"])
with p4: project_card("RecruitPilot AI", PROJECTS["RecruitPilot AI"])
p5, _ = st.columns(2)
with p5: project_card("SOPPilot AI", PROJECTS["SOPPilot AI"])
...
st.markdown('<div class="final-cta"><h2>Practical AI tools built to solve real operational problems.</h2><p>Client diagnostics. Operations visibility. Sales execution. Applicant review organization. Process documentation.</p></div>', unsafe_allow_html=True)
